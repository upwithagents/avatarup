// Smoke test for the LEGACY customizer page (moved off the app's primary
// route — see docs/imported-avatar-format.md and the third-party-avatar
// pivot). Requires `pnpm dev` running. Usage: node apps/web/e2e/legacy-smoke.mjs [baseUrl]
//
...
const BASE_URL = process.argv[2] ?? 'http://localhost:3000/avatarup/legacy';
